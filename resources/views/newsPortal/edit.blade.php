...
@section('content')
    <div class="contentInputFrom p-3">
        ...
        <div class="inputGroup mt-5">
            <form action="{{route('newsPortal.update')}}" method="post" enctype="multipart/form-data">
                @csrf
                @method('put')
                <div class="row">
                    <div class="col-6 s-12">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"
                                   placeholder="Enter Title" name="title" value="{{$newsData->title}}">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            >{{$newsData->short_description}}</textarea>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control summernote" id="exampleFormControlTextarea1 description"
                                      rows="3" placeholder="Write Content" name="content">{{$newsData->content}}</textarea>
                        </div>
                        @error('content')
                        <p class="mb-0 pb-4 text-caption text-danger">{{ $message }}</p>
                        @enderror
                    ...
                    <div class="col-6 s-12">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"
                                   placeholder="Enter Url" name="video_url" value="{{$newsData->video_url}}">
                        ...
                        <div class="image-preview mt-3 mb-3" id="previewTwo">
                            <h5 class=" pb-2">Image Preview</h5>
                            <img src="{{asset('storage/'.$newsData->featured_image)}}" alt="" id="outputTwo" class="w-100"/>
                        </div>
